...
function getMovie(search_value) {
  axios.get('https://www.omdbapi.com/?s=' + search_value + '&apikey=a5063d4f').then(response => {
...
module.exports = {
  ...
  action,
  action2 //we'll have to define each function here and export it
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "#movies img, #movie img{\r\n    width: 100%;\r\n    height: 100%;\r\n}\r\n\r\n\r\n#searchBtn{\r\n    margin-top: 10px;\r\n    margin-bottom: 10px;\r\n}", ""]);
// Exports
